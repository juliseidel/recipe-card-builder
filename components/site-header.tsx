    ...
    <header className="sticky top-0 z-30 w-full border-b border-line/60 bg-canvas/85 backdrop-blur-xl">
      <div className="mx-auto flex h-[68px] max-w-[1400px] items-center justify-between px-6 lg:px-10">
        ...
        <nav className="flex items-center gap-1.5">
          ...
          <a
            href="https://www.instagram.com/bienesfitlife/"
            target="_blank"
            rel="noreferrer noopener"
            className="hidden rounded-full px-4 py-1.5 text-sm font-medium text-ink-muted transition-colors hover:bg-surface hover:text-ink sm:inline-flex"
          >
            Inspiration
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="ml-1 hidden rounded-full bg-ink px-4 py-1.5 text-sm font-medium text-canvas transition-opacity hover:opacity-90 sm:inline-flex"
          >
            Quellcode
          </a>
        </nav>
