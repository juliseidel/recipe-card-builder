...
export default function NewBrandPage() {
  ...
  // Brand-Style-Detection wurde in PR 12 entfernt: DB-Brands rendern im
  // Reference-First-Modus, d.h. das Hero-Bild kommt direkt aus dem Reel.
  // Kein imageStyle in der DB noetig.
  ...
  const handleSave = async () => {
    ...
    const newBrand: Brand = {
      ...
      packCount: 0,
      recipeCount: 0,
      // PR 12: kein imageStyle mehr. Hero-Pipeline rendert DB-Brands
      // im Reference-First-Modus direkt aus dem Reel-Keyframe.
    };
